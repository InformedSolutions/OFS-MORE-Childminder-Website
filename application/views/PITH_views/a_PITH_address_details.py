...
from application.models.adult_in_home_address import AdultInHomeAddress
from application.forms.PITH_forms.PITH_address_details import (
                     PITHAddressForm,
                     PITHAddressManualLookupForm,
                     PITHAddressManualForm)
...
def pith_address_details(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'PITH_templates/PITH_address_details.html', variables)
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            pith_address_record = AdultInHomeAddress.objects.get(
                application_id=application_id_local, adult_in_home_address=1)
