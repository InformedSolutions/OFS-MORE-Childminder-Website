...
health_name_dict = collections.OrderedDict(('health_submission_consent', 'Will you submit a health declaration booklet to Ofsted'))
...
other_adult_summary_name_dict = collections.OrderedDict(('adults_in_home', 'Do you live with anyone who is 16 or over'))
