...
urlpatterns = [
    ...
    url(r'^criminal-record/type/$', views.DBSGuidanceView.as_view(), name='DBS-Type-View'),
    ...
    url(r'^criminal-record/MOD-checks/$', views.DBSMinistryOfDefence.as_view(), name='DBS-Ministry-Of-Defence-View'),
