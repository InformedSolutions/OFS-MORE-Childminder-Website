...
urlpatterns = [
    ...
    url(r'^sign-in/change-email/', views.update_email, name='Contact-Email-View'),
    ...
    url(r'^sign-in/check-email-change/$', views.login.check_email, name='Update-Email-Sent'),
    url(r'^sign-in/change-email-resent/$', views.login.email_resent, name='Update-Email-Resent'),
