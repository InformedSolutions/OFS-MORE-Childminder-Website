...
urlpatterns = [
    ...
    url(r'^childcare/timing-summary/', views.ChildcareTimingSummaryView.as_view(),
        name='Childcare-Timing-Summary-View'),
    ...
    url(r'^people/adults-address-check/$', PITH_views.PITHAdultAddressCheckView.as_view(), name='PITH-Address-Check-View'),
    url(r'^people/adults-address-details/$', PITH_views.PITHAddressDetailsView, name='PITH-Address-Details-View'),
    url(r'^people/adults-address-manual/$', PITH_views.PITHAddressManualView, name='PITH-Address-Manual-View'),
    url(r'^people/adults-address-select/$', PITH_views.PITHAddressSelectView, name='PITH-Address-Select-View'),
    ...
    url(r'^validate/(?P<code>[\w-]+)/$', magic_link.validate_magic_link, name='Validate-Email'),
    ...
    url(r'^sign-in/question/(?P<code>[\w-]+)/$', security_question.question, name='Security-Question'),
