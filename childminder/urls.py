...
urlpatterns = [
    ...
    url(r'^application-cancelled/$', views.cr_cancel_app_confirmation, name='CR-Cancel-Application-Confirmation'),
    ...
    url(r'^childcare-location/cancel-application/$', views.personal_details.service_unavailable,
